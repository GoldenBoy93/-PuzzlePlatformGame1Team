...
public class DigitWheel : MonoBehaviour
{
    ...
    [Header("Visual")]
    public Transform visual;        // 씬의 휠 Transform (없으면 회전 안 함)
    public float stepDegrees = 36f; // 360/10
    public float rotateSpeed = 540f;
    public bool smoothRotate = true; // 에디터/런타임에서 부드럽게 회전할지

    public Action onChanged;        // 콤보락이 구독
    ...
    public void SetValue(int v, bool instant = false)
    {
        ...
        targetAngleY = -Value * stepDegrees;   // 회전 방향 반대면 + 로 바꾸세요
